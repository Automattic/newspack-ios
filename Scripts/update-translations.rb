...
langs.each do |code,local|
  lang_dir = File.join('Newspack', 'Resources', "#{local}.lproj")
  puts "Updating #{code}"
  ...
  system "curl -sSfL --globoff -o #{lang_dir}/Localizable.strings https://translate.wordpress.com/projects/newspack/newspack-ios/#{code}/default/export-translations?format=strings" or begin
